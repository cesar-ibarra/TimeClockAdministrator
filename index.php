...
if( isset( $_POST['login'] ) ) {
    ...
    if( mysqli_num_rows($result) > 0 ) {
        ...
        // error message
        $loginError = "<div class='alert alert-danger text-center'>No such user in database. Please try again. <a class='close' data-dismiss='alert'>&times;</a></div>";
    }
...
<body>
  ...
  <div class="loginbox">
      ...
      <form action="<?php echo htmlspecialchars( $_SERVER['PHP_SELF'] ); ?>" method="post">
        ...
        <input class="mt-5" type="submit" name="login" value="Login">
