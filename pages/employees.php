      ...
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <dir class="col-sm-6 text-right">
          	<a href="addemployee.php" class="btn btn-sm btn-primary"><span class="fa fa-plus"></span> Add Employee</a>
          </dir>
                  ...
                  if( mysqli_num_rows($result) > 0 ) {
                          ...
                          {  
                               ...
                               <tr>  
                                    ...
                                    <td class="text-center"><a href="editemployee.php?id_employee=' . $row['id_employee'] . '" class="btn btn-sm btn-primary">
